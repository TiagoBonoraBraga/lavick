...
export default function SectionCard() {
  ...
  {/* Texto centralizado */}
  <div className="hidden md:block absolute top-[20%] left-1/2 transform -translate-x-1/2 text-white text-center p-6 md:p-10 rounded-lg w-full max-w-[900px] h-auto md:h-[200px]">
  ...
  <div className="absolute bottom-[-200px] left-1/2 transform -translate-x-1/2 mb-20 flex space-x-6">
    {/* Primeiro card */}
    <div className="bg-white shadow-lg rounded-lg p-6 w-[350px] md:w-[400px] lg:w-[450px]">
      <Image
        src={Comercial}
        alt="Imagem Card 1"
